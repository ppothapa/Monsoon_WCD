...
model_data_08    =  'rain_con_30_day.nc'
...
model_data_06    =  'rain_con_30_day.nc'
...
model_data_05    =  'rain_con_30_day.nc'
...
##   Here draw solid lines for the bins. 
     ...
     labels=["ICON (10KM) convective.rain", "ICON (40KM) convective.rain", "ICON (80KM) convective.rain","MSWEP (total prec)", "IMERG (total prec)"]
...
fig.savefig("Convection_Fig8_cumulative_PDF_plot_sub.pdf", bbox_inches='tight', pad_inches=0.1)
