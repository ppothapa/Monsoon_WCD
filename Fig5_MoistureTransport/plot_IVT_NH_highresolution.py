...
#    scale_units='xy'
    ...
    var_05_mag.plot(ax=ax4, transform=ccrs.PlateCarree(), cmap=cmap, norm=norm, cbar_kwargs={'pad': 0.02, 'label': 'Integrated Vertical Transport (Kg m-1 s-1)'})
...
# Title and axis labels
    ...
    ax1.set_title('ERA5 (Reference)',fontweight='bold', fontsize=10)
