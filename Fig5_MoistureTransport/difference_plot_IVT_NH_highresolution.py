...
#    scale_units='xy'
    ...
    diff_var_05_mag.plot(ax=ax3, transform=ccrs.PlateCarree(), cmap=cmap, norm=norm, cbar_kwargs={'pad': 0.02, 'label': 'Integrated Vertical Transport (Kg m-1 s-1)'})
...
#    scale_units='xy'
    ...
    diff_data = [
    diff_var_08_mag.values.flatten(),
    diff_var_06_mag.values.flatten(),
    diff_var_05_mag.values.flatten()
     ]
    ...
    ax4.set_ylabel('IVT Difference')
    ax4.set_title('ICON - ERA5')
