...
model_data_08    =  'tot_prec_80_day.nc'
...
model_data_06    =  'tot_prec_80_day.nc'
...
model_data_05    =  'tot_prec_80_day.nc'
...
model_data_imerg    =  'precipitation_cdo_all_rmp_10years_rmp_80.nc'
...
model_data_cpc    =  'precip.daily_rmp_10years_rmp_80.nc'
...
model_data_era5    =  'pr_day_reanalysis_era5_r1i1p1_daily_rmp_10years_rmp_80.nc'
...
model_data_mswep    = 'precip_rmp_10years_rmp_80.nc'
...
model_data_cmorph    = 'daily_rmp_10years_rmp_80.nc'
...
model_data_gpcc    = 'full_data_rmp_10years_rmp_80.nc'
...
##
     ...
     data_base_mask = '/capstor/store/cscs/userlab/cwp03/ppothapa/Paper_1_10km_Monsoon/Fig1_domains/Supplementry_Fig1/masks'
...
## Here introduce NA mask. 

     data_base_mask_na = '/capstor/store/cscs/userlab/cwp03/ppothapa/Paper_1_10km_Monsoon/Fig1_domains/Supplementry_Fig1/masks'

     mask_08_na='08_mask_2mm_55_na.nc'
     mask_06_na='06_mask_2mm_55_na.nc'
     mask_05_na='05_mask_2mm_55_na.nc'
     mask_era5_na='era5_mask_2mm_55_na.nc'
     mask_imerg_na='imerg_mask_2mm_55_na.nc'
     mask_cpc_na='cpc_mask_2mm_55_na.nc'
     mask_mswep_na='mswep_mask_2mm_55_na.nc'
     mask_cmorph_na='cmorph_mask_2mm_55_na.nc'
     mask_gpcc_na='gpcc_mask_2mm_55_na.nc'
     ...
     data_dir_mask_08_na = os.path.join(data_base_mask_na,mask_08_na)
     data_dir_mask_06_na = os.path.join(data_base_mask_na,mask_06_na)
     data_dir_mask_05_na = os.path.join(data_base_mask_na,mask_05_na)
     data_dir_mask_imerg_na = os.path.join(data_base_mask_na,mask_imerg_na)
     data_dir_mask_cpc_na = os.path.join(data_base_mask_na,mask_cpc_na)
     data_dir_mask_era5_na = os.path.join(data_base_mask_na,mask_era5_na)
     data_dir_mask_mswep_na = os.path.join(data_base_mask_na,mask_mswep_na)
     data_dir_mask_cmorph_na = os.path.join(data_base_mask_na,mask_cmorph_na)
     data_dir_mask_gpcc_na = os.path.join(data_base_mask_na,mask_gpcc_na)




#    Store the mask files. 
     ds_08_mask     = xr.open_dataset(data_dir_mask_08)
     ds_06_mask     = xr.open_dataset(data_dir_mask_06)
     ds_05_mask     = xr.open_dataset(data_dir_mask_05)
     ds_era5_mask   = xr.open_dataset(data_dir_mask_era5)
     ds_imerg_mask  = xr.open_dataset(data_dir_mask_imerg)
     ds_cpc_mask    = xr.open_dataset(data_dir_mask_cpc)
     ds_mswep_mask  = xr.open_dataset(data_dir_mask_mswep)
     ds_cmorph_mask = xr.open_dataset(data_dir_mask_cmorph)
     ds_gpcc_mask   = xr.open_dataset(data_dir_mask_gpcc)


#

     ds_08_mask_na     = xr.open_dataset(data_dir_mask_08_na)
     ds_06_mask_na     = xr.open_dataset(data_dir_mask_06_na)
     ds_05_mask_na     = xr.open_dataset(data_dir_mask_05_na)
     ds_era5_mask_na   = xr.open_dataset(data_dir_mask_era5_na)
     ds_imerg_mask_na  = xr.open_dataset(data_dir_mask_imerg_na)
     ds_cpc_mask_na    = xr.open_dataset(data_dir_mask_cpc_na)
     ds_mswep_mask_na  = xr.open_dataset(data_dir_mask_mswep_na)
     ds_cmorph_mask_na = xr.open_dataset(data_dir_mask_cmorph_na)
     ds_gpcc_mask_na   = xr.open_dataset(data_dir_mask_gpcc_na)
...
#    Variable Mask 
     ...
     var_08_mask_na      = ds_08_mask_na["__xarray_dataarray_variable__"]
     var_06_mask_na     = ds_06_mask_na["__xarray_dataarray_variable__"]
     var_05_mask_na     = ds_05_mask_na["__xarray_dataarray_variable__"]
     var_era5_mask_na   = ds_era5_mask_na["__xarray_dataarray_variable__"]
     var_imerg_mask_na  = ds_imerg_mask_na["__xarray_dataarray_variable__"]
     var_cpc_mask_na    = ds_cpc_mask_na["__xarray_dataarray_variable__"]
     var_mswep_mask_na  = ds_mswep_mask_na["__xarray_dataarray_variable__"]
     var_cmorph_mask_na = ds_cmorph_mask_na["__xarray_dataarray_variable__"]
     var_gpcc_mask_na   = ds_gpcc_mask_na["__xarray_dataarray_variable__"]
...
##   
     var_08_summer_winter_mag_na  = abs(var_08_summer_winter * var_08_mask_na)
     var_06_summer_winter_mag_na  = abs(var_06_summer_winter * var_06_mask_na)
     var_05_summer_winter_mag_na  = abs(var_05_summer_winter * var_05_mask_na)
     var_era5_summer_winter_mag_na = abs(var_era5_summer_winter * var_era5_mask_na)
     var_imerg_summer_winter_mag_na = abs(var_imerg_summer_winter * var_imerg_mask_na)
     var_cpc_summer_winter_mag_na   = abs(var_cpc_summer_winter * var_cpc_mask_na)
     var_mswep_summer_winter_mag_na = abs(var_mswep_summer_winter * var_mswep_mask_na)
     var_cmorph_summer_winter_mag_na = abs(var_cmorph_summer_winter * var_cmorph_mask_na)
     var_gpcc_summer_winter_mag_na   = abs(var_gpcc_summer_winter * var_gpcc_mask_na)
...
## Filtering values for the countours: 
     ...
     var_08_summer_winter_NH     = var_08_summer_winter_mag.where((var_08_summer_winter > 0) & (var_08_summer_winter.lat > -10),np.nan)
     var_08_summer_winter_SH     = var_08_summer_winter_mag.where((var_08_summer_winter < 0) & (var_08_summer_winter.lat < 10), np.nan)
     
     var_06_summer_winter_NH     = var_06_summer_winter_mag.where((var_06_summer_winter > 0) & (var_06_summer_winter.lat > -10),np.nan) 
     var_06_summer_winter_SH     = var_06_summer_winter_mag.where((var_06_summer_winter < 0) & (var_06_summer_winter.lat < 10), np.nan)

     var_05_summer_winter_NH     = var_05_summer_winter_mag.where((var_05_summer_winter > 0) & (var_05_summer_winter.lat > -10),np.nan)
     var_05_summer_winter_SH     = var_05_summer_winter_mag.where((var_05_summer_winter < 0) & (var_05_summer_winter.lat < 10), np.nan)
 
     var_era5_summer_winter_NH   = var_era5_summer_winter_mag.where((var_era5_summer_winter > 0) & (var_era5_summer_winter.lat > -10),np.nan) 
     var_era5_summer_winter_SH   = var_era5_summer_winter_mag.where((var_era5_summer_winter < 0) & (var_era5_summer_winter.lat < 10), np.nan)   

     var_imerg_summer_winter_NH  = var_imerg_summer_winter_mag.where((var_imerg_summer_winter > 0) & (var_imerg_summer_winter.lat > -10),np.nan)
     var_imerg_summer_winter_SH  = var_imerg_summer_winter_mag.where((var_imerg_summer_winter < 0) & (var_imerg_summer_winter.lat < 10), np.nan)    

     var_cpc_summer_winter_NH    = var_cpc_summer_winter_mag.where((var_cpc_summer_winter > 0) & (var_cpc_summer_winter.lat > -10),np.nan)
     var_cpc_summer_winter_SH    = var_cpc_summer_winter_mag.where((var_cpc_summer_winter < 0) & (var_cpc_summer_winter.lat < 10), np.nan)

     var_mswep_summer_winter_NH  = var_mswep_summer_winter_mag.where((var_mswep_summer_winter > 0) & (var_mswep_summer_winter.lat > -10),np.nan)
     var_mswep_summer_winter_SH  = var_mswep_summer_winter_mag.where((var_mswep_summer_winter < 0) & (var_mswep_summer_winter.lat < 10), np.nan)    

     var_cmorph_summer_winter_NH = var_cmorph_summer_winter_mag.where((var_cmorph_summer_winter > 0) & (var_cmorph_summer_winter.lat > -10),np.nan)
     var_cmorph_summer_winter_SH = var_cmorph_summer_winter_mag.where((var_cmorph_summer_winter < 0) & (var_cmorph_summer_winter.lat < 10), np.nan)    

     var_gpcc_summer_winter_NH   = var_gpcc_summer_winter_mag.where((var_gpcc_summer_winter > 0) & (var_gpcc_summer_winter.lat > -10),np.nan)
     var_gpcc_summer_winter_SH   = var_gpcc_summer_winter_mag.where((var_gpcc_summer_winter < 0) & (var_gpcc_summer_winter.lat < 10), np.nan)




     # Calculate correlations for IMERG
     corr_imerg_08, p_value_imerg_08 = calculate_spatial_correlation(var_08_summer_winter_mag_na, var_imerg_summer_winter_mag_na)
     corr_imerg_06, p_value_imerg_06 = calculate_spatial_correlation(var_06_summer_winter_mag_na, var_imerg_summer_winter_mag_na)
     corr_imerg_05, p_value_imerg_05 = calculate_spatial_correlation(var_05_summer_winter_mag_na, var_imerg_summer_winter_mag_na)

     rmse_imerg_08  = calculate_spatial_rmse(var_08_summer_winter_mag_na, var_imerg_summer_winter_mag_na)
     rmse_imerg_06  = calculate_spatial_rmse(var_06_summer_winter_mag_na, var_imerg_summer_winter_mag_na)
     rmse_imerg_05  = calculate_spatial_rmse(var_05_summer_winter_mag_na, var_imerg_summer_winter_mag_na)

     # Calculate correlations for MSWEP
     corr_mswep_08, p_value_mswep_08 = calculate_spatial_correlation(var_08_summer_winter_mag_na, var_mswep_summer_winter_mag_na)
     corr_mswep_06, p_value_mswep_06 = calculate_spatial_correlation(var_06_summer_winter_mag_na, var_mswep_summer_winter_mag_na)
     corr_mswep_05, p_value_mswep_05 = calculate_spatial_correlation(var_05_summer_winter_mag_na, var_mswep_summer_winter_mag_na)

     rmse_mswep_08  = calculate_spatial_rmse(var_08_summer_winter_mag_na, var_mswep_summer_winter_mag_na)
     rmse_mswep_06  = calculate_spatial_rmse(var_06_summer_winter_mag_na, var_mswep_summer_winter_mag_na)
     rmse_mswep_05  = calculate_spatial_rmse(var_05_summer_winter_mag_na, var_mswep_summer_winter_mag_na)

      # Calulate for ERA5

     corr_era5_08, p_value_era5_08 = calculate_spatial_correlation(var_08_summer_winter_mag_na, var_era5_summer_winter_mag_na)
     corr_era5_06, p_value_era5_06 = calculate_spatial_correlation(var_06_summer_winter_mag_na, var_era5_summer_winter_mag_na)
     corr_era5_05, p_value_era5_05 = calculate_spatial_correlation(var_05_summer_winter_mag_na, var_era5_summer_winter_mag_na)

     rmse_era5_08  = calculate_spatial_rmse(var_08_summer_winter_mag_na, var_era5_summer_winter_mag_na)
     rmse_era5_06  = calculate_spatial_rmse(var_06_summer_winter_mag_na, var_era5_summer_winter_mag_na)
     rmse_era5_05  = calculate_spatial_rmse(var_05_summer_winter_mag_na, var_era5_summer_winter_mag_na)


     # Calculate for CMORPH

     corr_cmorph_08, p_value_cmorph_08 = calculate_spatial_correlation(var_08_summer_winter_mag_na, var_cmorph_summer_winter_mag_na)
     corr_cmorph_06, p_value_cmorph_06 = calculate_spatial_correlation(var_06_summer_winter_mag_na, var_cmorph_summer_winter_mag_na)
     corr_cmorph_05, p_value_cmorph_05 = calculate_spatial_correlation(var_05_summer_winter_mag_na, var_cmorph_summer_winter_mag_na)

     rmse_cmorph_08  = calculate_spatial_rmse(var_08_summer_winter_mag_na, var_cmorph_summer_winter_mag_na)
     rmse_cmorph_06  = calculate_spatial_rmse(var_06_summer_winter_mag_na, var_cmorph_summer_winter_mag_na)
     rmse_cmorph_05  = calculate_spatial_rmse(var_05_summer_winter_mag_na, var_cmorph_summer_winter_mag_na)


     # Calculate for CPC

     corr_cpc_08, p_value_cpc_08 = calculate_spatial_correlation(var_08_summer_winter_mag_na, var_cpc_summer_winter_mag_na)
     corr_cpc_06, p_value_cpc_06 = calculate_spatial_correlation(var_06_summer_winter_mag_na, var_cpc_summer_winter_mag_na)
     corr_cpc_05, p_value_cpc_05 = calculate_spatial_correlation(var_05_summer_winter_mag_na, var_cpc_summer_winter_mag_na)

     rmse_cpc_08  = calculate_spatial_rmse(var_08_summer_winter_mag_na, var_cpc_summer_winter_mag_na)
     rmse_cpc_06  = calculate_spatial_rmse(var_06_summer_winter_mag_na, var_cpc_summer_winter_mag_na)
     rmse_cpc_05  = calculate_spatial_rmse(var_05_summer_winter_mag_na, var_cpc_summer_winter_mag_na)


     # Calculöate for GPCC

     corr_gpcc_08, p_value_gpcc_08 = calculate_spatial_correlation(var_08_summer_winter_mag_na, var_gpcc_summer_winter_mag_na)
     corr_gpcc_06, p_value_gpcc_06 = calculate_spatial_correlation(var_06_summer_winter_mag_na, var_gpcc_summer_winter_mag_na)
     corr_gpcc_05, p_value_gpcc_05 = calculate_spatial_correlation(var_05_summer_winter_mag_na, var_gpcc_summer_winter_mag_na)
 
     rmse_gpcc_08  = calculate_spatial_rmse(var_08_summer_winter_mag_na, var_gpcc_summer_winter_mag_na)
     rmse_gpcc_06  = calculate_spatial_rmse(var_06_summer_winter_mag_na, var_gpcc_summer_winter_mag_na)
     rmse_gpcc_05  = calculate_spatial_rmse(var_05_summer_winter_mag_na, var_gpcc_summer_winter_mag_na)
...
#  Plotting the figures with a 2X2 Matrix
     ...
     if season=='NH_Summer':
         plot = var_08_summer_winter_mag_na.plot.contourf(
                      ax=ax1,
...
#                                   'orientation': 'horizontal'}, 
     ...
     # Add coast line 
         plot = var_08_summer_winter_mag.plot.contour(ax=ax1,levels=[2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
         plot = var_08_summer_winter_mag.plot.contour(ax=ax1,levels=[-2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
...
#   Figure 2
     ...
     if season=='NH_Summer':
         plot = var_06_summer_winter_mag_na.plot.contourf(
                      ax=ax2,
                      transform=ccrs.PlateCarree(),
                      cmap='Spectral_r',
                      norm=norm, add_colorbar=False,add_labels=False,
 ...
 #                                  'orientation': 'horizontal'},
     ...
     # Add coast line
         plot = var_06_summer_winter_mag.plot.contour(ax=ax2,levels=[2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
         plot = var_06_summer_winter_mag.plot.contour(ax=ax2,levels=[-2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
...
#    Figure 3
     ...
     if season=='NH_Summer':
        plot_cf = var_05_summer_winter_mag_na.plot.contourf(
                      ax=ax3,
                      transform=ccrs.PlateCarree(),
                      cmap='Spectral_r',
                      norm=norm,
...
#                                   'orientation': 'horizontal'},
     ...
     # Add coast line
        plot = var_05_summer_winter_mag.plot.contour(ax=ax3,levels=[2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
        plot = var_05_summer_winter_mag.plot.contour(ax=ax3,levels=[-2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
...
# Figure 4 
     ...
     if season=='NH_Summer':
        plot = var_era5_summer_winter_mag_na.plot.contourf(
                      ax=ax4,
                      transform=ccrs.PlateCarree(),
                      cmap='Spectral_r',
                      norm=norm, add_colorbar=False,add_labels=False,
...
#                                   'orientation': 'horizontal'},
     ...
     # Add coast line
        plot = var_era5_summer_winter_mag.plot.contour(ax=ax4,levels=[2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
        plot = var_era5_summer_winter_mag.plot.contour(ax=ax4,levels=[-2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
   ...
   #     ax4.add_feature(cart.feature.OCEAN, zorder=100, edgecolor='k',facecolor=(1,1,1))
     ...
     if season=='NH_Summer':
        plot = var_imerg_summer_winter_mag_na.plot.contourf(
                      ax=ax5,
                      transform=ccrs.PlateCarree(),
                      cmap='Spectral_r',
                      norm=norm, add_colorbar=False,add_labels=False,
...
#                                   'orientation': 'horizontal'},
     ...
     # Add coast line
        plot = var_imerg_summer_winter_mag.plot.contour(ax=ax5,levels=[2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
        plot = var_imerg_summer_winter_mag.plot.contour(ax=ax5,levels=[-2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
   ...
   #     ax4.add_feature(cart.feature.OCEAN, zorder=100, edgecolor='k',facecolor=(1,1,1))
     ...
     if season=='NH_Summer':
        plot_cf = var_cpc_summer_winter_mag_na.plot.contourf(
                      ax=ax6,
                      transform=ccrs.PlateCarree(),
                      cmap='Spectral_r',
                      norm=norm,
...
#                                   'orientation': 'horizontal'},
     ...
     # Add coast line
        plot = var_cpc_summer_winter_mag.plot.contour(ax=ax6,levels=[2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
        plot = var_cpc_summer_winter_mag.plot.contour(ax=ax6,levels=[-2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
   ...
   #     ax4.add_feature(cart.feature.OCEAN, zorder=100, edgecolor='k',facecolor=(1,1,1))
     ...
     if season=='NH_Summer':
        plot = var_gpcc_summer_winter_mag_na.plot.contourf(
                      ax=ax7,
                      transform=ccrs.PlateCarree(),
                      cmap='Spectral_r',
                      norm=norm,add_colorbar=False,add_labels=False,
...
#                                   'orientation': 'horizontal'},
     ...
     # Add coast line
        plot = var_gpcc_summer_winter_mag.plot.contour(ax=ax7,levels=[2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
        plot = var_gpcc_summer_winter_mag.plot.contour(ax=ax7,levels=[-2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
 ...
 # Figure 8
     ...
     if season=='NH_Summer':
        plot = var_mswep_summer_winter_mag_na.plot.contourf(
                          ax=ax8,
                      transform=ccrs.PlateCarree(),
                      cmap='Spectral_r',
                      norm=norm,add_colorbar=False,add_labels=False,
...
#                                   'orientation': 'horizontal'},
     ...
     # Add coast line
        plot = var_mswep_summer_winter_mag.plot.contour(ax=ax8,levels=[2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
        plot = var_mswep_summer_winter_mag.plot.contour(ax=ax8,levels=[-2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
   ...
   #     ax4.add_feature(cart.feature.OCEAN, zorder=100, edgecolor='k',facecolor=(1,1,1))
     ...
     if season=='NH_Summer':
        plot_cf = var_cmorph_summer_winter_mag_na.plot.contourf(
                      ax=ax9,
                      transform=ccrs.PlateCarree(),
                      cmap='Spectral_r',
                      norm=norm,
...
#                      vmax=100,
     ...
     # Add coast line
        plot = var_cmorph_summer_winter_mag.plot.contour(ax=ax9,levels=[2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
        plot = var_cmorph_summer_winter_mag.plot.contour(ax=ax9,levels=[-2.0], transform=ccrs.PlateCarree(), colors=['k'],linewidths=0.2 )
...
#Save the Figure in png format
     ...
     fig.savefig("absolute_GM_precipitation_samecontour.pdf", bbox_inches='tight', pad_inches=0.1)


     ds_to_save = xr.Dataset()

     # Add all your calculated variables to the dataset
     ds_to_save['var_08_summer_winter_mag_na'] = var_08_summer_winter_mag_na
     ...
     ds_to_save['var_06_summer_winter_mag_na'] = var_06_summer_winter_mag_na
     ...
     ds_to_save['var_05_summer_winter_mag_na'] = var_05_summer_winter_mag_na
     ...
     ds_to_save['var_imerg_summer_winter_mag_na'] = var_imerg_summer_winter_mag_na
...
# ---------------------------------------------------------------------------------
     output_filename = 'calculated_data_for_plotting_samecontour.nc'
