...
# ---------------------------------------------------------------------------------
ds = xr.open_dataset('calculated_data_for_plotting_samecontour.nc')
...
corr_data = {
    'IMERG': [0.778, 0.822, 0.792],  # [ICON-08, ICON-06, ICON-05]
    'MSWEP': [0.768, 0.785, 0.748],
    'ERA5':  [0.777, 0.786, 0.752],
    'CMORPH':[0.727, 0.760, 0.730],
    'CPC':   [0.664, 0.691, 0.633],
    'GPCC':  [0.770, 0.800, 0.771]
}

# RMSE Values
rmse_data = {
    'IMERG': [2.555, 2.215, 2.222],
    'MSWEP': [2.666, 2.475, 2.450],
    'ERA5':  [2.544, 2.385, 2.386],
    'CMORPH':[3.080, 2.808, 2.641],
    'CPC':   [2.804, 2.571, 2.549],
    'GPCC':  [2.497, 2.307, 2.462]
}
