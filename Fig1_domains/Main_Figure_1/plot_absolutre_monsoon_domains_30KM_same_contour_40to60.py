...
# Select Lat & Lon focussing on the tropics 
     var_08 = var_08.sel(lat=slice(-40,60))
     var_06 = var_06.sel(lat=slice(-40,60))
     var_05 = var_05.sel(lat=slice(-40,60))
     var_imerg = var_imerg.sel(lat=slice(-40,60))
     var_cpc = var_cpc.sel(lat=slice(-40,60))
     var_era5 = var_era5.sel(lat=slice(-40,60))
     var_mswep = var_mswep.sel(lat=slice(-40,60))
     var_cmorph = var_cmorph.sel(lat=slice(-40,60))
     var_gpcc = var_gpcc.sel(lat=slice(-40,60))
...
##
     ...
     data_base_mask = '/capstor/store/cscs/userlab/cwp03/ppothapa/Paper_1_10km_Monsoon/Fig1_domains/masks_40to60'
...
## Here introduce NA mask. 
     ...
     data_base_mask_na = '/capstor/store/cscs/userlab/cwp03/ppothapa/Paper_1_10km_Monsoon/Fig1_domains/masks_40to60'
...
# ---------------------------------------------------------------------------------
     output_filename = 'calculated_data_for_plotting_samecontour_40to60.nc'
