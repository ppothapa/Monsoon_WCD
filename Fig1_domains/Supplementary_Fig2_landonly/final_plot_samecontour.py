...
corr_data = {
    'IMERG': [0.810, 0.812, 0.779],  # [ICON-08, ICON-06, ICON-05]
    'MSWEP': [0.757, 0.743, 0.703],
    'ERA5':  [0.772, 0.745, 0.700],
    'CMORPH':[0.688, 0.683, 0.639],
...
# RMSE Values
rmse_data = {
    'IMERG': [2.128, 2.044, 2.158],
    'MSWEP': [2.430, 2.417, 2.486],
    'ERA5':  [2.361, 2.441, 2.581],
    'CMORPH':[2.740, 2.608, 2.479],
