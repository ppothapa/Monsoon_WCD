...
# ---------------------------------------------------------------------------------
ds = xr.open_dataset('calculated_data_for_plotting.nc')
...
create_spatial_plot(ax1, var_08_mag, var_08_nh, var_08_sh, '(b) ICON (10 km)')

ax2 = fig.add_subplot(gs[1, 0], projection=proj)
create_spatial_plot(ax2, var_06_mag, var_06_nh, var_06_sh, '(c) ICON (40 km)')

ax3 = fig.add_subplot(gs[1, 1], projection=proj)
create_spatial_plot(ax3, var_05_mag, var_05_nh, var_05_sh, '(d) ICON- (80 km)')

# Row 2: IMERG (centered)
ax4 = fig.add_subplot(gs[0, 0], projection=proj)
create_spatial_plot(ax4, var_imerg_mag, var_imerg_nh, var_imerg_sh, '(a) IMERG (Reference)')
...
fig.savefig("Master_1.pdf", bbox_inches='tight', pad_inches=0.1)
#plt.show()
