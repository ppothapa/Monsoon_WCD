...
#   Multiply with the Mask. 
    var_08_summer            = var_08_summer * mask_08
    var_06_summer            = var_06_summer * mask_06
    var_05_summer            = var_05_summer * mask_05
...
# v vonset_data[key] = mean_onset_doy
    ...
    var_08_onset_difference        = var_08_onset - var_obs_imerg_onset
    var_06_onset_difference        = var_06_onset - var_obs_imerg_onset
    var_05_onset_difference        = var_05_onset - var_obs_imerg_onset
    ...
    tick_doys = np.arange(-40, 40.1, 4)  # 10-day intervals within the March-July range
...
#  Preparing for the figures & Spceifying the Projections
    ...
    var_08_onset_difference.plot.contourf(ax=ax2, transform=ccrs.PlateCarree(), cmap=cmap, norm=norm, add_colorbar=False, add_labels=False)
#     plot = diff_sum_win_08.plot.contour(ax=ax1,levels=[-2], transform=ccrs.PlateCarree(), colors=['r'],linewidths=2.5) 
    ...
    var_06_onset_difference.plot.contourf(ax=ax3, transform=ccrs.PlateCarree(), cmap=cmap, norm=norm, add_colorbar=False, add_labels=False)
#     plot = diff_sum_win_06.plot.contour(ax=ax1,levels=[-2], transform=ccrs.PlateCarree(), colors=['g'],linewidths=2.5)
    ...
    var_05_onset_difference.plot.contourf(ax=ax4, transform=ccrs.PlateCarree(), cmap=cmap, norm=norm,  add_colorbar=False, add_labels=False)
...
fig.savefig("Fig3_Monsoon_domains.pdf", bbox_inches='tight', pad_inches=0.1)
