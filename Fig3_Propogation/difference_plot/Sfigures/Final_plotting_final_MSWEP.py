...
#   Multiply with the Mask. 
    var_08_summer            = var_08_summer * mask_mswep 
    var_06_summer            = var_06_summer * mask_mswep
    var_05_summer            = var_05_summer * mask_mswep
...
# Difference in the domain
    var_08_onset_difference        = var_08_onset_clean - var_obs_mswep_onset_clean 
    var_06_onset_difference        = var_06_onset_clean - var_obs_mswep_onset_clean
    var_05_onset_difference        = var_05_onset_clean - var_obs_mswep_onset_clean
...
fig.savefig("SFig_Monsoon_Onset_Bias_MSWEP.pdf", bbox_inches='tight', pad_inches=0.1)
