...
evolve_var_08_summer_annual  = var_08_summer.resample(time='YE').mean()
evolve_var_08_winter_annual  = var_08_winter.resample(time='YE').mean()
print(evolve_var_08_summer_annual.shape)

evolve_var_06_summer_annual  = var_06_summer.resample(time='YE').mean()
evolve_var_06_winter_annual  = var_06_winter.resample(time='YE').mean()
print(evolve_var_06_summer_annual.shape)

evolve_var_05_summer_annual  = var_05_summer.resample(time='YE').mean()
evolve_var_05_winter_annual  = var_05_winter.resample(time='YE').mean()
print(evolve_var_05_summer_annual.shape)

evolve_var_era5_summer_annual = var_era5_summer.resample(time='YE').mean() * 86400
evolve_var_era5_winter_annual = var_era5_winter.resample(time='YE').mean() * 86400
print(evolve_var_era5_summer_annual.shape)

evolve_var_imerg_summer_annual = var_imerg_summer.resample(time='YE').mean()
evolve_var_imerg_winter_annual = var_imerg_winter.resample(time='YE').mean()
print(evolve_var_imerg_summer_annual.shape)

evolve_var_cpc_summer_annual = var_cpc_summer.resample(time='YE').mean()
evolve_var_cpc_winter_annual = var_cpc_winter.resample(time='YE').mean()
print(evolve_var_cpc_summer_annual.shape)

evolve_var_mswep_summer_annual = var_mswep_summer.resample(time='YE').mean()
evolve_var_mswep_winter_annual = var_mswep_winter.resample(time='YE').mean()
print(evolve_var_mswep_summer_annual.shape)

evolve_var_cmorph_summer_annual = var_cmorph_summer.resample(time='YE').mean()
evolve_var_cmorph_winter_annual = var_cmorph_winter.resample(time='YE').mean()
print(evolve_var_cmorph_summer_annual.shape)

evolve_var_gpcc_summer_annual = var_gpcc_summer.resample(time='YE').mean()
evolve_var_gpcc_winter_annual = var_gpcc_winter.resample(time='YE').mean()
print(evolve_var_gpcc_summer_annual.shape)


# This is the Climatological Mean of the Summer/Winter Precipitatio
evolve_var_08_summer_annual_std = evolve_var_08_summer_annual.std(dim='time', skipna=True)
evolve_var_06_summer_annual_std = evolve_var_06_summer_annual.std(dim='time', skipna=True)
evolve_var_05_summer_annual_std = evolve_var_05_summer_annual.std(dim='time', skipna=True)
evolve_var_imerg_summer_annual_std = evolve_var_imerg_summer_annual.std(dim='time', skipna=True)
evolve_var_era5_summer_annual_std = evolve_var_era5_summer_annual.std(dim='time', skipna=True)
evolve_var_cpc_summer_annual_std = evolve_var_cpc_summer_annual.std(dim='time', skipna=True)
evolve_var_mswep_summer_annual_std = evolve_var_mswep_summer_annual.std(dim='time', skipna=True)
evolve_var_cmorph_summer_annual_std = evolve_var_cmorph_summer_annual.std(dim='time', skipna=True)
evolve_var_gpcc_summer_annual_std = evolve_var_gpcc_summer_annual.std(dim='time', skipna=True)

evolve_var_08_winter_annual_std = evolve_var_08_winter_annual.std(dim='time', skipna=True)
evolve_var_06_winter_annual_std = evolve_var_06_winter_annual.std(dim='time', skipna=True)
evolve_var_05_winter_annual_std = evolve_var_05_winter_annual.std(dim='time', skipna=True)
evolve_var_imerg_winter_annual_std = evolve_var_imerg_winter_annual.std(dim='time', skipna=True)
evolve_var_era5_winter_annual_std = evolve_var_era5_winter_annual.std(dim='time', skipna=True)
evolve_var_cpc_winter_annual_std = evolve_var_cpc_winter_annual.std(dim='time', skipna=True)
evolve_var_mswep_winter_annual_std = evolve_var_mswep_winter_annual.std(dim='time', skipna=True)
evolve_var_cmorph_winter_annual_std = evolve_var_cmorph_winter_annual.std(dim='time', skipna=True)
evolve_var_gpcc_winter_annual_std = evolve_var_gpcc_winter_annual.std(dim='time', skipna=True)


#  Save the netcdf data for standard deviation.

evolve_var_08_summer_annual_std.to_netcdf("evolve_var_08_summer_annual_std.nc")
evolve_var_06_summer_annual_std.to_netcdf("evolve_var_06_summer_annual_std.nc")
evolve_var_05_summer_annual_std.to_netcdf("evolve_var_05_summer_annual_std.nc")
evolve_var_imerg_summer_annual_std.to_netcdf("evolve_var_imerg_summer_annual_std.nc")
evolve_var_era5_summer_annual_std.to_netcdf("evolve_var_era5_summer_annual_std.nc")
evolve_var_cpc_summer_annual_std.to_netcdf("evolve_var_cpc_summer_annual_std.nc")
evolve_var_mswep_summer_annual_std.to_netcdf("evolve_var_mswep_summer_annual_std.nc")
evolve_var_cmorph_summer_annual_std.to_netcdf("evolve_var_cmorph_summer_annual_std.nc")
evolve_var_gpcc_summer_annual_std.to_netcdf("evolve_var_gpcc_summer_annual_std.nc")


#   Here calculate the Interannal Variability Variance

# This is the Climatological Mean of the Summer/Winter Precipitatio
evolve_var_08_summer_annual_var = evolve_var_08_summer_annual.var(dim='time', skipna=True)
evolve_var_06_summer_annual_var = evolve_var_06_summer_annual.var(dim='time', skipna=True)
evolve_var_05_summer_annual_var = evolve_var_05_summer_annual.var(dim='time', skipna=True)
evolve_var_imerg_summer_annual_var = evolve_var_imerg_summer_annual.var(dim='time', skipna=True)
evolve_var_era5_summer_annual_var = evolve_var_era5_summer_annual.var(dim='time', skipna=True)
evolve_var_cpc_summer_annual_var = evolve_var_cpc_summer_annual.var(dim='time', skipna=True)
evolve_var_mswep_summer_annual_var = evolve_var_mswep_summer_annual.var(dim='time', skipna=True)
evolve_var_cmorph_summer_annual_var = evolve_var_cmorph_summer_annual.var(dim='time', skipna=True)
evolve_var_gpcc_summer_annual_var = evolve_var_gpcc_summer_annual.var(dim='time', skipna=True)

evolve_var_08_winter_annual_var = evolve_var_08_winter_annual.var(dim='time', skipna=True)
evolve_var_06_winter_annual_var = evolve_var_06_winter_annual.var(dim='time', skipna=True)
evolve_var_05_winter_annual_var = evolve_var_05_winter_annual.var(dim='time', skipna=True)
evolve_var_imerg_winter_annual_var = evolve_var_imerg_winter_annual.var(dim='time', skipna=True)
evolve_var_era5_winter_annual_var = evolve_var_era5_winter_annual.var(dim='time', skipna=True)
evolve_var_cpc_winter_annual_var = evolve_var_cpc_winter_annual.var(dim='time', skipna=True)
evolve_var_mswep_winter_annual_var = evolve_var_mswep_winter_annual.var(dim='time', skipna=True)
evolve_var_cmorph_winter_annual_var = evolve_var_cmorph_winter_annual.var(dim='time', skipna=True)
evolve_var_gpcc_winter_annual_var = evolve_var_gpcc_winter_annual.var(dim='time', skipna=True)
### Saving the Data

evolve_var_08_summer_annual_var.to_netcdf("evolve_var_08_summer_annual_var.nc")
evolve_var_06_summer_annual_var.to_netcdf("evolve_var_06_summer_annual_var.nc")
evolve_var_05_summer_annual_var.to_netcdf("evolve_var_05_summer_annual_var.nc")
evolve_var_imerg_summer_annual_var.to_netcdf("evolve_var_imerg_summer_annual_var.nc")
evolve_var_era5_summer_annual_var.to_netcdf("evolve_var_era5_summer_annual_var.nc")
evolve_var_cpc_summer_annual_var.to_netcdf("evolve_var_cpc_summer_annual_var.nc")
evolve_var_mswep_summer_annual_var.to_netcdf("evolve_var_mswep_summer_annual_var.nc")
evolve_var_cmorph_summer_annual_var.to_netcdf("evolve_var_cmorph_summer_annual_var.nc")
evolve_var_gpcc_summer_annual_var.to_netcdf("evolve_var_gpcc_summer_annual_var.nc")
