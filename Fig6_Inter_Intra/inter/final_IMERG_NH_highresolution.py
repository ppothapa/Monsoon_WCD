...
data_base_dir = '/capstor/store/cscs/userlab/cwp03/ppothapa/Paper_1_10km_Monsoon/Fig6_Inter_Intra/inter/data'

model_data_08    =  'evolve_var_08_summer_annual_var.nc'

model_data_06    =  'evolve_var_06_summer_annual_var.nc'

model_data_05    =  'evolve_var_05_summer_annual_var.nc'

model_data_obs_imerg    =  'evolve_var_imerg_summer_annual_var.nc'
...
#     plot = diff_sum_win_06.plot.contour(ax=ax1,levels=[-2], transform=ccrs.PlateCarree(), colors=['g'],linewidths=2.5)
  ...
  # 
   ...
   # Create box plot
    ...
    ax4.set_ylabel('Variance (interannual)', fontweight='bold', fontsize=10)
...
fig.savefig("Fig7_Interannual.pdf", bbox_inches='tight', pad_inches=0.1)
