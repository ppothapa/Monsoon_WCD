...
############
    ...
    tick_doys = np.arange(0, 5.1, 0.05)  # 10-day intervals within the March-July range
    tick_doys_bar = np.arange(0, 5.1, 0.5)
...
fig.savefig("Fig7_inter.pdf", bbox_inches='tight', pad_inches=0.1)
