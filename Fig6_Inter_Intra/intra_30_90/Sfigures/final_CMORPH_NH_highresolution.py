...
model_data_obs_cmorph    =  'evolve_var_cmorph_summer_intraseasonal_var.nc'
...
model_data_dir_obs_cmorph    = os.path.join(data_base_dir, model_data_obs_cmorph)
...
# Read the Variable from Here.  
    ...
    var_obs_cmorph = ds_obs_cmorph["__xarray_dataarray_variable__"]
...
#    var_obs_cmorph = var_obs_cmorph.transpose()
...
## Selecting for CORE Region
    ...
    mask_cmorph_core = mask_cmorph.sel(lat=slice(lat_min_core,lat_max_core),lon=slice(lon_min_core,lon_max_core))
...
## Select for CORE
    ...
    var_obs_cmorph_core = var_obs_cmorph.sel(lat=slice(lat_min_core,lat_max_core),lon=slice(lon_min_core,lon_max_core))

#### 
  
    var_08 = var_08 * mask_cmorph 
    var_06 = var_06 * mask_cmorph
    var_05 = var_05 * mask_cmorph
    var_obs_cmorph = var_obs_cmorph * mask_cmorph

####

    var_08_core = var_08_core * mask_cmorph_core
    var_06_core = var_06_core * mask_cmorph_core
    var_05_core = var_05_core * mask_cmorph_core
    var_obs_cmorph_core = var_obs_cmorph_core * mask_cmorph_core


######

    var_08 = var_08/var_obs_cmorph
    var_06 = var_06/var_obs_cmorph
    var_05 = var_05/var_obs_cmorph
...
#######
    ...
    var_08_core = var_08_core/var_obs_cmorph_core
    var_06_core = var_06_core/var_obs_cmorph_core
    var_05_core = var_05_core/var_obs_cmorph_core
...
#     plot = diff_sum_win_06.plot.contour(ax=ax1,levels=[-2], transform=ccrs.PlateCarree(), colors=['g'],linewidths=2.5)
  ...
  # 
   ...
   # Create box plot
    ...
    ax4.set_ylabel('Variance (30-60 day)', fontweight='bold', fontsize=10)
...
# Title and axis labels
    ...
    ax1.set_title('ICON (10KM)/CMORPH (Ratio)',fontweight='bold', fontsize=10)
    ...
    ax2.set_title('ICON (40KM)/CMORPH (Ratio)',fontweight='bold', fontsize=10)
...
#    ax2.set_title('Average Monsoon Onset Date (Calendar Format - 10 Day Intervals)')
    ax3.set_title('ICON (80KM)/CMORPH (Ratio)',fontweight='bold', fontsize=10)
...
fig.savefig("Fig7_Intra_30_90_CMORPH.pdf", bbox_inches='tight', pad_inches=0.1)
