...
data_base_dir = '/capstor/store/cscs/userlab/cwp03/ppothapa/Paper_1_10km_Monsoon/Fig6_Inter_Intra/intra_30_90/data'
...
# New Color Scheme
    ...
    np.linspace(1.0, 3.0, 128)     # Start at 1.0
    ])
    norm = BoundaryNorm(tick_doys, cmap.N)
...
fig.savefig("Fig7_Intra_30_90.pdf", bbox_inches='tight', pad_inches=0.1)
