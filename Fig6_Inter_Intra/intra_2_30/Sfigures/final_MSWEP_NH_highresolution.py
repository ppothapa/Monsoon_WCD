...
model_data_obs_mswep    =  'evolve_var_mswep_summer_intraseasonal_var.nc'
...
# Read the Variable from Here.  
    ...
    var_obs_mswep = ds_obs_mswep["__xarray_dataarray_variable__"]
...
#    var_obs_mswep = var_obs_mswep.transpose()
...
######
    ...
    var_08 = var_08/var_obs_mswep
    var_06 = var_06/var_obs_mswep
    var_05 = var_05/var_obs_mswep
...
#######
    ...
    var_08_core = var_08_core/var_obs_mswep_core
    var_06_core = var_06_core/var_obs_mswep_core
    var_05_core = var_05_core/var_obs_mswep_core
...
# Title and axis labels
    ...
    ax1.set_title('ICON (10KM)/MSWEP (Ratio)',fontweight='bold', fontsize=10)
    ...
    ax2.set_title('ICON (40KM)/MSWEP (Ratio)',fontweight='bold', fontsize=10)
...
#    ax2.set_title('Average Monsoon Onset Date (Calendar Format - 10 Day Intervals)')
    ax3.set_title('ICON (80KM)/MSWEP (Ratio)',fontweight='bold', fontsize=10)
...
fig.savefig("Fig7_Intra_2_30_MWSEP.pdf", bbox_inches='tight', pad_inches=0.1)
