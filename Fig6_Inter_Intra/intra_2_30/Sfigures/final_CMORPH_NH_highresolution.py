...
data_base_dir = '/capstor/store/cscs/userlab/cwp03/ppothapa/Paper_1_10km_Monsoon/Fig6_Inter_Intra/intra_2_30/data'
...
#     plot = diff_sum_win_06.plot.contour(ax=ax1,levels=[-2], transform=ccrs.PlateCarree(), colors=['g'],linewidths=2.5)
  ...
  # 
   ...
   # Create box plot
    ...
    ax4.set_ylabel('Variance (2-30 day)', fontweight='bold', fontsize=10)
...
fig.savefig("Fig7_Intra_2_30_CMORPH.pdf", bbox_inches='tight', pad_inches=0.1)
