...
model_data_obs_era5    =  'evolve_var_era5_summer_intraseasonal_var.nc'
...
model_data_dir_obs_era5    = os.path.join(data_base_dir, model_data_obs_era5)
...
# Read the Variable from Here.  
    ...
    var_obs_era5 = ds_obs_era5["__xarray_dataarray_variable__"]
...
#    var_obs_era5 = var_obs_era5.transpose()
...
## Select for CORE
    ...
    var_obs_era5_core = var_obs_era5.sel(lat=slice(lat_min_core,lat_max_core),lon=slice(lon_min_core,lon_max_core))

#### 
  
    var_08 = var_08 * mask_era5 
    var_06 = var_06 * mask_era5
    var_05 = var_05 * mask_era5
    var_obs_era5 = var_obs_era5 * mask_era5

####

    var_08_core = var_08_core * mask_era5_core
    var_06_core = var_06_core * mask_era5_core
    var_05_core = var_05_core * mask_era5_core
    var_obs_era5_core = var_obs_era5_core * mask_era5_core


######

    var_08 = var_08/var_obs_era5
    var_06 = var_06/var_obs_era5
    var_05 = var_05/var_obs_era5
...
#######
    ...
    var_08_core = var_08_core/var_obs_era5_core
    var_06_core = var_06_core/var_obs_era5_core
    var_05_core = var_05_core/var_obs_era5_core
...
# Title and axis labels
    ...
    ax1.set_title('ICON (10KM)/ERA5 (Ratio)',fontweight='bold', fontsize=10)
    ...
    ax2.set_title('ICON (40KM)/ERA5 (Ratio)',fontweight='bold', fontsize=10)
...
#    ax2.set_title('Average Monsoon Onset Date (Calendar Format - 10 Day Intervals)')
    ax3.set_title('ICON (80KM)/ERA5 (Ratio)',fontweight='bold', fontsize=10)
...
fig.savefig("Fig7_Intra_2_30_ERA5.pdf", bbox_inches='tight', pad_inches=0.1)
