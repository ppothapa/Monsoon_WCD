...
data_base_dir = '/capstor/store/cscs/userlab/cwp03/ppothapa/Paper_1_10km_Monsoon/Fig6_Inter_Intra/intra_2_30/logp_transformation/data'
...
############
    ...
    tick_doys = np.arange(0, 1.5, 0.015)  # 10-day intervals within the March-July range
    tick_doys_bar = np.arange(0, 1.5, 0.15)
    tick_doys = np.concatenate([
    np.linspace(0, 0.999, 128),    # Stop just before 1.0
    np.linspace(1.0, 1.5, 128)     # Start at 1.0
    ])
...
fig.savefig("Fig7_Intra_2_30_logp.pdf", bbox_inches='tight', pad_inches=0.1)
